...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Tenés los precios completos acá arriba, sin letras chicas. Los 4 planes incluyen todo —ARCA, listas de precio, promociones, compras y cuenta corriente—; lo único que cambia es cuántas sucursales, cajas y depósitos manejás. Probás 14 días gratis, sin tarjeta, y te ayudamos a migrar tu catálogo del Excel.',
  },
  {
